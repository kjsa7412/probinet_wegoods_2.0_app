...
const Support_User_Status_Date = ({ navigation }) => {
    ...
    >
      ...
      <HeaderBase
        ...
        rightItem={[
          ...
          },
          {
            ...
            link: () =>
              navigation.push("Support_User_Status_Artist", {
      ...
      >
        ...
        <TotalContainer>
          ...
          <Text fontsize={15}>누적 서포트 금액</Text>
        </TotalContainer>
...
export default Support_User_Status_Date;
